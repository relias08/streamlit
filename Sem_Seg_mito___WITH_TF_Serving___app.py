...
# Basically if we are deploying the Sem_Seg_mito model using Streamlit from Colab using ngrok, this file should be called 
# inside the following Colab file in My Google Drive:
